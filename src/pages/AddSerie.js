...
class AddSerie extends Component{
    ...
    async submit(e){
        ...
        let reponse =await SerieService.create(body);
        if(reponse.ok){
            this.setState({
                success:true,
                messageSuccess:"Serie bien crée"
            })
        }
    }
        ...
        return(
            <div className="container">
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control"  id="synopsis" onChange={(e)=>this.handleChange(e)} />
                </div>
                <div>
                ...
                <div>
                    <label>Année</label>
                    <input type="text" className="form-control"  id="annee" onChange={(e)=>this.handleChange(e)}/>
                </div>
                <div align="center">
                    <button className="btn btn-jaune" onClick={()=>this.retour()}><FontAwesomeIcon icon={faChevronLeft} />  Retour</button>  
                    <button className="btn btn-noir" type="submit" ><FontAwesomeIcon icon={faPlus} /> Ajouter une série</button>
                </div>
                </form>
                {
